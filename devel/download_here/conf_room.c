...
// This code is distributed subject to the General Public License that
// comes with the MudOS driver. Generally, you may modify this file as
// you like but you must retain this header, you must retain the General
// Public License, and you may not redistribute for profit, or charge for
// the use of this code. See the copy of the License that came with your
// gamedriver for the full details.
...
#define DEFAULT_LOG_DIR "/u/m/mobydick/logs"
...
#define DEFAULT_ECHO_ROOM "/u/m/mobydick/workroom"
...
#define DEFAULT_BOUNCE_ROOM "/d/TMI/tower1"
...
#define MEETING_HELP "/u/m/mobydick/meeting.help"
#define MODERATE_HELP "/u/m/mobydick/moderate.help"
#define RULES_HELP "/u/m/mobydick/rules.help"
...
// The conference room has a rather rudimentary create function which
// initializes variables and so forth. You should create a seperate room
// which inherits this file, which sets light and descriptions and so forth.
// Have it call ::create(), of course.
...
// room. Otherwise they can spam up the log. You will need to alter your
// cmd_hook function to check if the quiet property equals 1 before allowing
// people to use soul commands. It's a one-line fix: feel free to come by
// TMI-2 and see how we did it.
