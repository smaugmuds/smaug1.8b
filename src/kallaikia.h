...
#define BACKUP_DIR	"../xogadores/backup/" /* Backup Player files	*/
#define GOD_DIR		"../deuses/"	/* God Info Dir			*/
#define BOARD_DIR	"../taboeiros/"	/* Board data dir		*/
#define CLAN_DIR	"../clans/"	/* Clan data dir		*/
#define COUNCIL_DIR  	"../concellos/"  /* Council data dir		*/
#define DEITY_DIR	"../deidades/"	/* Deity data dir		*/
#define BUILD_DIR       "../construir/"  /* Online building save dir     */
...
#define VAULT_DIR	"../baules/" 	/* storage vaults 		*/ 
#define HOUSE_DIR       "../fogares/" 	/* Houses 			*/
...
#define BAN_LIST        "ban.lista"    		  	 /* List of bans                 */
#define RESERVED_LIST	"reservados.lista"		/* List of reserved names	*/
#define NOAUCTION_LIST	"nosubastar.lista"		 /* list of vnums not to allow auction to */
#define CLAN_LIST	"clans.lista"			/* List of clans		*/
#define COUNCIL_LIST	"concellos.lista"		/* List of councils		*/
...
#define VAULT_LIST      "baules.lista" 			/* list of storage vaults 	*/
#define HOUSE_LIST      "fogares.lista"			/* list of houses 		*/
#define BOARD_FILE	"taboeiros.lista"			/* For bulletin boards	 */
...
#define IMM_HOST_FILE   SYSTEM_DIR 	"inmortal.host"	/* For stoping hackers */
#define ADMINLIST_FILE  SYSTEM_DIR 	"administradores.lista" /* Adminlist */
#define RIPSCREEN_FILE	SYSTEM_DIR 	"kallaikia_pantalla.rip"
#define RIPTITLE_FILE	SYSTEM_DIR 	"kallaikia_titulo.rip"
#define ANSITITLE_FILE	SYSTEM_DIR 	"kallaikia_titulo.ans"
#define ASCTITLE_FILE	SYSTEM_DIR 	"kallaikia_titulo.asc"
#define IDEA_FILE	SYSTEM_DIR 	"ideas.datos"		/* For 'idea'		 */
#define TYPO_FILE	SYSTEM_DIR 	"tipos.datos"	  	/* For 'typo'		 */
#define HINT_FILE       SYSTEM_DIR 	"consellos.datos"    	/* For Hints */
#define HINTSUB_FILE	SYSTEM_DIR 	"consellossuxerencias.datos" 	/* For hint suggestions */
#define CHANGE_FILE	SYSTEM_DIR 	"cambios.datos"  	/* For add_change      */
#define IMMNEWS_FILE	SYSTEM_DIR 	"novasinm.datos" 	/* For add_imm_news    */
#define PLEVEL_FILE	SYSTEM_DIR 	"niveis.datos" 	/* Char level info */
#define RETIREDLIST_FILE SYSTEM_DIR 	"retirados.datos"	/* Retiredlist	 */
#define WIZLIST_FILE	SYSTEM_DIR 	"wiz.datos"  	/* Wizlist		 */
#define WHO_FILE	SYSTEM_DIR 	"quen.datos"	  	/* Who output file	 */
#define WEBWHO_FILE	SYSTEM_DIR 	"quenweb.datos"	  	/* WWW Who output file */
#define SKILL_FILE	SYSTEM_DIR 	"habilidades.datos"   	/* Skill table	 */
#define LOGIN_MSG	SYSTEM_DIR 	"introduccion.msg"	  	/* List of login msgs	*/
#define HERB_FILE	SYSTEM_DIR 	"herbas.datos"	  	/* Herb table		 */
#define TONGUE_FILE	SYSTEM_DIR 	"linguas.datos"  	/* Tongue tables	 */
#define SOCIAL_FILE	SYSTEM_DIR 	"sociais.datos"  	/* Socials		 */
#define COMMAND_FILE	SYSTEM_DIR 	"comandos.datos" 	/* Commands		 */
#define PROJECTS_FILE	SYSTEM_DIR 	"proxectos.datos" 	/* For projects	 */
#define PLANE_FILE	SYSTEM_DIR 	"planos.datos"	  	/* For planes		 */
#define COLOR_FILE	SYSTEM_DIR 	"cores.datos"	  	/* User-definable color*/
#define TEMP_FILE	PLAYER_DIR 	"gardarxogador.tmp" 	/* More char save protect */
#define MEMBERS_FILE	SYSTEM_DIR 	"membros.datos"  	/* Store the members lists */
#define STANCE_FILE     SYSTEM_DIR 	"estancias.datos"
#define MORPH_FILE      SYSTEM_DIR 	"polimorfismo.datos"     	/* For morph data */

#define NEWS_FILE       SYSTEM_DIR      "novas.datos"
#define NEWS_INCLUDE_FILE SYSTEM_DIR    "novas_attachments.datos"

#define HOMEBUY_FILE          HOUSE_DIR "comprafogar.datos"   	/* Houses data */
#define ACCESSORIES_FILE      HOUSE_DIR "accesoriosfogar.datos"   /* Home accesory data */
