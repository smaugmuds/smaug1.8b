...
void load_homedata()
{
   ...
   char buf[MAX_STRING_LENGTH];
	...
	{
		log_string ( "Cannot open fogares.lista for reading. Home loading aborted.");
		shutdown_mud( "No fogares.lista" );
		exit(1);
        }
...
void update_house_list( )
{
    ...
    {
		bug( "FATAL: cannot open fogares.lista for writing!\n\r", 0 );
		return;
	}
...
void save_accessories()
{
    ...
    {
        bug( "Cannot open accesoriosfogar.datos for writing", 0 );
...
void load_accessories()
{
    ...
    {
		boot_log( "Cannot open accesoriosfogar.datos. Aborting loadup of accessories data." ); 
		return;
	}
...
void save_homebuy()
{
    ...
    {
		boot_log( "Cannot open compafogar.datos for writing", 0);
        perror( HOMEBUY_FILE );
		return;
    }
...
void load_homebuy()
{
    ...
    {
		boot_log( "Cannot open comprafogar.datos Aborting loadup of home auction data." );
		return;
	}
